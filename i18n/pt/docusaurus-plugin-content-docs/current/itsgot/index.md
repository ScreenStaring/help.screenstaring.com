...
sidebar_position: 0
description: Como usar o aplicativo It's Got Nutrition Facts para Shopify.
---
...
- [Criando Rótulos em Vários Idiomas](/docs/itsgot/multi-language)
- [Combinando Componentes de Refeição para Gerar um Rótulo](/docs/itsgot/combine-api)
- [Importando Produtos](/docs/itsgot/importing-products)
